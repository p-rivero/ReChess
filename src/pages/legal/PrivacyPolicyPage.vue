...
<p><strong>Last updated March 12, 2023</strong></p>
<p>This privacy notice for ReChess ("<strong>Company</strong>," "<strong>we</strong>," "<strong>us</strong>," or "<strong>our</strong>"), describes how and why we might collect, store, use, and/or share ("<strong>process</strong>") your information when you use our services ("<strong>Services</strong>"), such as when you:</p>
<ul>
  <li>Visit our website at <a href="https://rechess.org">https://rechess.org</a>, or any website of ours that links to this privacy notice</li>
</ul>
<ul>
  <li>Engage with us in other related ways, including any sales, marketing, or events</li>
</ul>
<p><strong>Questions or concerns?&nbsp;</strong>Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:admin@rechess.org">admin@rechess.org</a>.</p>
<p><strong>SUMMARY OF KEY POINTS</strong></p>
<p><strong>This summary provides key points from our privacy notice, but you can find out more details about any of these topics by clicking the link following each key point or by using our table of contents below to find the section you are looking for. You can also click&nbsp;</strong><a href="#toc"><strong>here</strong></a><strong>&nbsp;to go directly to our table of contents.</strong></p>
<p><strong>What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with ReChess and the Services, the choices you make, and the products and features you use. Click&nbsp;<a href="#personalinfo">here</a>&nbsp;to learn more.</p>
...
<p><strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by filling out our data subject request form available <a href="https://app.termly.io/notify/f3da9e8d-3391-476f-a6c6-4762d768b71e">here</a>, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</p>
<p>Want to learn more about what ReChess does with any information we collect? Click&nbsp;<a href="#toc">here</a>&nbsp;to review the notice in full.</p>
...
<h2 id="legalbases"><strong>3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</strong></h2>
...
<h2 id="whoshare"><strong>4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</strong></h2>
...
<p>Google account and Github account</p>
<ul>
...
<p>Google Fonts</p>
<ul>
  <li><strong>Functionality and Infrastructure Optimization</strong></li>
</ul>
<p>Cloud Firestore,&nbsp;Cloud Functions for Firebase ,&nbsp;Cloud Storage for Firebase and Firebase Hosting</p>
<ul>
  <li><strong>User Account Registration and Authentication</strong></li>
</ul>
<p>GitHub OAuth and Google OAuth 2.0</p>
<ul>
...
<h2 id="cookies"><strong>5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</strong></h2>
...
<h2 id="sociallogins"><strong>6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</strong></h2>
...
<h2 id="inforetain"><strong>7. HOW LONG DO WE KEEP YOUR INFORMATION?</strong></h2>
...
<h2 id="infosafe"><strong>8. HOW DO WE KEEP YOUR INFORMATION SAFE?</strong></h2>
...
<h2 id="infominors"><strong>9. DO WE COLLECT INFORMATION FROM MINORS?</strong></h2>
<p><strong>In Short:</strong>&nbsp;We do not knowingly collect data from or market to children under 18 years of age.</p>
<p>We do not knowingly solicit data from or market to children under 18 years of age. By using the Services, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the Services. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at <a href="mailto:admin@rechess.org">admin@rechess.org</a>.</p>
<h2 id="privacyrights"><strong>10. WHAT ARE YOUR PRIVACY RIGHTS?</strong></h2>
...
<p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:admin@rechess.org">admin@rechess.org</a>.</p>
<h2 id="DNT"><strong>11. CONTROLS FOR DO-NOT-TRACK FEATURES</strong></h2>
...
<h2 id="caresidents"><strong>12. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</strong></h2>
...
<h2 id="policyupdates"><strong>13. DO WE MAKE UPDATES TO THIS NOTICE?</strong></h2>
...
<h2 id="contact"><strong>14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</strong></h2>
<p>If you have questions or comments about this notice, you may contact our Data Protection Officer (DPO) , Pol Rivero Sallent,&nbsp;by email at&nbsp;<a href="mailto:admin@rechess.org">admin@rechess.org</a>.</p>
<p>If you are a resident in the European Economic Area, the "data controller" of your personal information is ReChess. ReChess has appointed Pol Rivero Sallent to be its representative in the EEA. You can contact them directly regarding the processing of your information by ReChess, by email at <a href="mailto:admin@rechess.org">admin@rechess.org</a>.</p>
<h2 id="request"><strong>15. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</strong></h2>
<p>You have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please send us an email at <a href="mailto:admin@rechess.org">admin@rechess.org</a>.</p>
...
<style>
  html {
    ...
    /* Add padding for navbar plus 1 rem */
