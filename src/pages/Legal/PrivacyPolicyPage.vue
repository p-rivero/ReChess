<template>
  <div class="content has-text-justified">
    ...
    <p><strong>In Short:</strong><strong />We collect personal information that you provide to us.</p>
    ...
    <p><strong>In Short:</strong><strong />Some information — such as your Internet Protocol (IP) address and/or browser and device characteristics — is collected automatically when you visit our Services.</p>
